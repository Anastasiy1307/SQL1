...
public class ADD extends AppCompatActivity {
    ...
    public void onClickADD(View v)
    {
        ...
        EditText Name = findViewById(R.id.edtMarka);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        try {
                            ...
                            if (connection != null) {
                                if(img==null)
                                {
                                    query = "INSERT INTO Auto (Name,Power) VALUES ('" + Name.getText() + "', '" + Power.getText() + "')";
                                }
                                else
                                {
                                    query = "INSERT INTO Auto (Name, Power, Image) VALUES ('" + Name.getText() + "', '" + Power.getText() + "', '"+img+"')";
                                }
